Bad Bank is a React project that simulates bank deposits and withdrawals. To access these features, users must first log in using the credentials provided in the "All Data" tab.
